    ...
    <div class="wrapper">
        <div class="grid__item block_heading grid--table grid--full style_default">
            <div class="area-header grid__item one-third">
                <h2>
                    <a href="#">Recherche :</a>
                    <span style="color: #333!important;">{{ $phones->isNotEmpty() ? $phones->count() . ' résultat(s) trouvé(s) ' : 'Aucun résultat trouvé'  }}</span>
                </h2>
            </div>
        </div>
                        ...
                        <div class="shop-by-content" id="tags-filter-content">
                            <div class="filter-tag-group">
                                ...
                                <div class="tag-group grid__item one-quarter" id="coll-filter-4">
                                    <form
                                        method="get" class="input-group search-bar " role="search" style="position: relative;width: 100%;display: flex;">
                                        <input name="query" wire:model.debounce.500ms="query" type="search"
                                               style="border-color: #1570B7;height: 50px;color: #000;width: 100%;border-color: #d9d9d9;"
