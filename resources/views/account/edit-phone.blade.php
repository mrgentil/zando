...
@section('title') @parent Modifier le livre {{ $book->name }} @endsection
        ...
        <section class="kopa-area kopa-area-16 kopa-area-parallax white-text-style">
            ...
            <div class="container">
                ...
                <div class="kopa-breadcrumb">
                    ...
                    <h3>Modifier le livre {{ $book->name }}</h3>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                <a itemprop="url" class="current-page">
                                    <span itemprop="title">Modifier le livre {{ $book->name }}</span>
                                </a>
                            </span>
                    </div>
                            ...
                            <div class="widget-content">
                                <div class="entry-content">
                                    <div class="woocommerce">
                                        <form name="checkout" method="post" enctype="multipart/form-data"
                                              class="checkout woocommerce-checkout" action="{{ route('account.book.update', $book) }}">
                                                ...
                                                <div class="col-1">
                                                    <div class="woocommerce-billing-fields">
                                                        ...
                                                        <p class="form-row form-row-wide">
                                                            ...
                                                            <input type="text" class="input-text" id="title" name="title" value="{{ old('title') ? old('title') : $book->title }}" autofocus>
                                                            @error('title')
                                                        ...
                                                        <p class="form-row form-row-wide">
                                                            ...
                                                            <select id="status" name="status">
                                                                <option {{ $book->status === 'PAYANT' ? 'selected' : '' }} value="PAYANT">Payant</option>
                                                                <option  {{ $book->status === 'GRATUIT' ? 'selected' : '' }} value="GRATUIT">Gratuit</option>
                                                            </select>
                                                        </p>
                                                        <p class="form-row form-row-wide">
                                                            <label for="cost">Prix (laissez vide si le livre est gratuit)</label>
                                                            <input type="number" class="input-text" id="cost" name="cost" value="{{ old('cost') ? old('cost') : $book->cost }}" autofocus>
                                                            @error('cost')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="woocommerce-shipping-fields">
                                                        <p class="form-row form-row notes">
                                                            ...
                                                            <textarea style="min-height: 100px" class="input-text " id="description"
                                                                      placeholder="Une petite description pour votre livre." name="description" rows="2" cols="20">{{ old('description') ? old('description') : $book->description }}</textarea>
                                                            @error('description')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
