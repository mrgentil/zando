...
@section('title') @parent Lecture du livre {{ $book->title }} @endsection
        ...
        <section class="kopa-area kopa-area-16 kopa-area-parallax white-text-style">
            ...
            <div class="container">
                ...
                <div class="kopa-breadcrumb">
                    ...
                    <h3>Lecture du livre {{ str_limit($book->title, 90) }}</h3>
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                <a itemprop="url" class="current-page">
                                    <span itemprop="title">Lecture du livre {{ str_limit($book->title, 90) }}</span>
                                </a>
                            </span>
                    </div>
                        ...
                        <div class="widget ct-widget-2">
                            <div class="widget-content">
                                <div class="widget-content-area-2" style="margin-top: 0;">
                                    <iframe src ="{{ asset("/zamengAppPdfView/#../storage/{$book->download_link}") }}" width="1000px" height="600px"></iframe>
                                </div>
                            </div>
                        </div>
                        <!-- widget -->
